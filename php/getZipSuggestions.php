...
try
{
    ...
    $sql = "SELECT Zipcode, ABS( Zipcode - ".$zipcode.") AS distance FROM ( (SELECT Zipcode FROM `zipcode` WHERE Zipcode >= ".$zipcode." ORDER BY Zipcode LIMIT 5 ) UNION ALL ( SELECT Zipcode FROM `zipcode` WHERE Zipcode < ".$zipcode." ORDER BY Zipcode DESC LIMIT 5)) AS result ORDER BY distance LIMIT 6";
